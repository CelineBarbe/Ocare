...
export const SUB_CABINET_OK = "SUB_CABINET_OK";
export const UNSUB_CABINET = "UNSUB_CABINET";
export const UNSUB_CABINET_OK = "UNSUB_CABINET_OK";
export const SUB_NURSE_CABINET = "SUB_NURSE_CABINET";
export const UNSUB_NURSE_CABINET_OK = "UNSUB_NURSE_CABINET_OK";
export const SUB_NURSE_CABINET_OK = "SUB_NURSE_CABINET_OK";
